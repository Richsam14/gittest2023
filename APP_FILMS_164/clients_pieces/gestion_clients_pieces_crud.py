...
"""
    Nom : clients_pieces_afficher
    Auteur : OM 2021.05.01
    Définition d'une "route" /clients_pieces_afficher
...
@app.route("/clients_pieces_afficher/<int:id_piece_sel>", methods=['GET', 'POST'])
def clients_pieces_afficher(id_piece_sel):
    print(" clients_pieces_afficher id_piece_sel ", id_piece_sel)
    if request.method == "GET":
        try:
            with DBconnection() as mc_afficher:
                strsql_clients_pieces_afficher_data = """SELECT * FROM t_client e1
                ...
                if id_piece_sel == 0:
                    ...
                    mc_afficher.execute(strsql_clients_pieces_afficher_data)
                else:
                    ...
                    strsql_clients_pieces_afficher_data += """ HAVING id_piece= %(value_id_piece_selected)s"""
                ...
                if not data_clients_genres_afficher and id_piece_sel == 0:
                    ...
                    flash(f"Données pièces et clients affichés !!", "success")

        except Exception as Exception_clients_pieces_afficher:
...
"""
    ...
    Récupère la liste de tous les genres du film sélectionné par le bouton "MODIFIER" de "clients_pieces_afficher.html"
...
def edit_genre_film_selected():
    if request.method == "GET":
        try:
            ...
            # Récupère la valeur de "id_film" du formulaire html "clients_pieces_afficher.html"
            # l'utilisateur clique sur le bouton "Modifier" et on récupère la valeur de "id_film"
            # grâce à la variable "id_film_genres_edit_html" dans le fichier "clients_pieces_afficher.html"
            ...
            # Constitution d'un dictionnaire pour associer l'id du film sélectionné avec un nom de variable
            valeur_id_piece_selected_dictionnaire = {"value_id_piece_selected": id_film_genres_edit}
...
def update_genre_film_selected():
    if request.method == "POST":
        try:
            ...
            id_piece_selected = session['session_id_film_genres_edit']
            ...
            with DBconnection() as mconn_bd:
                ...
                for id_genre_ins in lst_diff_genres_insert_a:
                    ...
                    valeurs_film_sel_genre_sel_dictionnaire = {"value_fk_film": id_piece_selected,
    ...
    return redirect(url_for('clients_pieces_afficher', id_piece_sel=id_piece_selected))
...
def genres_films_afficher_data(valeur_id_piece_selected_dict):
    ...
    try:
        ...
        strsql_film_selected = """SELECT id_film, nom_film, duree_film, description_film, cover_link_film, date_sortie_film, GROUP_CONCAT(id_genre) as GenresFilms FROM t_genre_film
                                        ...
                                        WHERE id_film = %(value_id_piece_selected)s"""
        ...
        with DBconnection() as mc_afficher:
            ...
            mc_afficher.execute(strsql_genres_films_non_attribues, valeur_id_piece_selected_dict)
            # Récupère les données de la requête.
            ...
            # Envoi de la commande MySql
            mc_afficher.execute(strsql_film_selected, valeur_id_piece_selected_dict)
            # Récupère les données de la requête.
            ...
            # Envoi de la commande MySql
            mc_afficher.execute(strsql_genres_films_attribues, valeur_id_piece_selected_dict)
            # Récupère les données de la requête.
